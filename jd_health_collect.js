...
=====================Loon================
[Script]
cron "5-45/20 0,1,2,3 * * *" script-path=jd_health_collect.js, tag=东东健康社区收集能量

====================Surge================
东东健康社区收集能量 = type=cron,cronexp="5-45/20 0,1,2,3 * * *",wake-system=1,timeout=3600,script-path=jd_health_collect.js

============小火箭=========
东东健康社区收集能量 = type=cron,script-path=jd_health_collect.js, cronexpr="5-45/20 0,1,2,3 * * *", timeout=3600, enable=true
 */
