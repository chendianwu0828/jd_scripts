...
===============Surge=================
京东极速版红包 = type=cron,cronexp="0,12,22 * * *",wake-system=1,timeout=3600,script-path=jd_speed_redpocke.js

============小火箭=========
京东极速版红包 = type=cron,script-path=jd_speed_redpocke.js, cronexpr="0,12,22 * * *", timeout=3600, enable=true
*/
